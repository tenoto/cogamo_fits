...
def get_parser():
	...
	"""
	parser = argparse.ArgumentParser('cgm_convert_rawcsv_to_fitsfile.py',
		formatter_class=argparse.RawDescriptionHelpFormatter,
		description="""
Convert a raw csv-format CoGaMo event file to a fits-format event file.
		"""
		)
	...
	parser.add_argument('input_csv', type=str, 
		help='input raw csv-format event file obtained with the CoGaMo.')
